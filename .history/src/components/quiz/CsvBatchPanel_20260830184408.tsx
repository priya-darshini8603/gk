...
const generateAll = async () => {
  ...
  try {
    ...
    if (!narrationOk) {
      toast.warning(
        "Narration capture wasn't granted. Videos will render with SFX only.",
      );
    }

    /*
     * Keep one render active because AudioEngine owns one capture pipeline.
     *
     * The optimized export.ts handles encoder work much more efficiently.
     */
