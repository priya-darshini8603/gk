...
export function QuizPlayer({
  ...
  useEffect(() => {
    ...
    // NEW: narration buffers must be decoded before we start the loop,
    // otherwise the first few "say" cues would fire before playSpeech() has
    // anything to play (same async-decode problem as the exporter).
    void (async () => {
