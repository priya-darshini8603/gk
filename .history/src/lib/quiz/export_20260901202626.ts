 ...
 * NEXT RENDER TICK
 *
 * requestAnimationFrame is throttled aggressively in background / hidden tabs,
 * which makes the export loop appear to hang and can leave gaps in the
 * generated timeline. Use a small timer instead so the export keeps advancing
 * in a predictable way regardless of browser scheduling pressure.
 * ------------------------------------------------------------------------- */
