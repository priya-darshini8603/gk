...
export async function renderVideo(
  ...
  for (
    ...
    if (beat.say) {
       ...
       *
       * renderBeat(beat) has already displayed
       * the end card for its 2.2 seconds.
       *
       * This is the ONLY end card.
       */
      if (
        beat.kind ===
        "endcard"
        ...
        console.log(
          "[export] Final end card completed.",
        );
      }
   ...
   * In particular, it does NOT render another end card.
   * --------------------------------------------------------------------- */
